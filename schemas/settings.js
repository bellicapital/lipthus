...
module.exports = function settings(Schema, site) {
	...
	const s = new Schema({
		...
		type: String,
		value: {type: Schema.Types.Mixed, noWatermark: true, get: function(val) {
			//noinspection JSUnresolvedVariable
			if(val && val.MongoBinData)
				{ //noinspection JSUnresolvedFunction,JSUnresolvedVariable,JSPotentiallyInvalidUsageOfThis
