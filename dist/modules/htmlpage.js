...
class HtmlPage {
    constructor(req, res) {
        ...
        this.jQuery = true;
        this.logLinks = false;
        this.head = new htmlheadmanager_1.HeadManager(req, res);
        this.noCache = true;
    ...
    load() {
        ...
        this.addJSVars({
            ...
            logLink: this.logLinks && config.log_links,
    ...
    setMetaDescription() {
        ...
        if (this.metaDescription instanceof mltext_1.MultilangText)
...
function HtmlPageMiddleware(req, res, next) {
    let ret;
...
exports.HtmlPageMiddleware = HtmlPageMiddleware;
